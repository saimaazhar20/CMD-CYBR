          ...
          <div className="bg-gray-900 rounded-lg p-8 mb-8">
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                <h3 className="text-lg font-bold text-white mb-4 md:mb-0">Affiliations</h3>
                <div className="flex items-center space-x-6">
                  <div className="bg-gray-700 px-4 py-2 rounded">
                    <span className="text-gray-300 text-sm font-semibold">JAS-ANZ G</span>
                  </div>
                  <div className="bg-gray-700 px-4 py-2 rounded flex items-center gap-2">
                    <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-300 text-sm font-semibold">ISO 27001 CERTIFIED</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-700">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              <div className="flex flex-wrap justify-center md:justify-end space-x-6">
                ...
                <a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Terms and Conditions</a>
                <a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Vulnerability Disclosure Policy</a>
                <a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Security Advisories</a>
              </div>
              <p className="text-gray-400 text-sm">©2025 CMD:CYBR Cybersecurity Pty Limited | ABN: 19 617 435 711</p>
            </div>
          </div>
        </div>
      </div>
