        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-8 text-center shadow-lg">
              <div className="w-24 h-24 bg-gradient-to-br from-blue-900 to-blue-700 rounded-full mx-auto mb-6 flex items-center justify-center">
                <span className="text-2xl font-bold text-white">JS</span>
              </div>
              <h3 className="text-xl font-bold text-blue-900 mb-2">John Smith</h3>
              <p className="text-orange-500 font-semibold mb-4">Chief Executive Officer</p>
            ...
            <div className="bg-white rounded-lg p-8 text-center shadow-lg">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-2">Maria Johnson</h3>
              <p className="text-orange-500 font-semibold mb-4">Chief Technology Officer</p>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-white rounded-lg p-8 text-center shadow-lg">
              ...
              <h3 className="text-xl font-bold text-blue-900 mb-2">David Brown</h3>
              <p className="text-orange-500 font-semibold mb-4">Chief Security Officer</p>
              <p className="text-gray-600 text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">We strive for the highest standards in everything we do, continuously improving our services and solutions.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">We operate with honesty, transparency, and ethical practices in all our business relationships.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">We embrace new technologies and methodologies to stay ahead of evolving cyber threats.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">We are deeply committed to protecting our clients and building long-term partnerships based on trust.</p>
            </div>
          </div>
        </div>
      </section>
