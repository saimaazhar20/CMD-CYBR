          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-semibold text-blue-900 mb-4">Sydney Office</h3>
                  <div className="space-y-2 text-gray-600">
                    <p>Level 12, Suite 6</p>
                    <p>189 Kent Street</p>
                    <p>Sydney NSW 2000</p>
                    <p className="text-blue-600 font-semibold">T. 1300 211 235</p>
                ...
                <div>
                  ...
                  <div className="space-y-1 text-gray-600">
                    ...
                    <p>Sunday: Closed</p>
                    <p className="text-orange-500 font-semibold">24/7 Emergency Support Available</p>
                  </div>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-blue-900 mb-4">Emergency Contact</h3>
                  <div className="space-y-2 text-gray-600">
                    <p className="text-red-600 font-semibold">Security Incident Hotline</p>
                    <p className="text-2xl font-bold text-red-600">1-866-579-2200</p>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-blue-900 rounded-full flex items-center justify-center text-white hover:bg-blue-800 transition-colors duration-200">
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-orange-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-orange-600 transition-colors duration-200 text-lg"
                >
                  Send Message
                </button>
              </form>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-blue-900 mb-3">How quickly can you respond to a security incident?</h3>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-blue-900 mb-3">What industries do you serve?</h3>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-blue-900 mb-3">Do you offer free consultations?</h3>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-blue-900 mb-3">What certifications do your team members have?</h3>
