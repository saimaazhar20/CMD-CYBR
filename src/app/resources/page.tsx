        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200 slide-up">
              ...
              <h3 className="text-xl font-bold text-black mb-4">Whitepapers</h3>
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200 slide-up">
              ...
              <h3 className="text-xl font-bold text-black mb-4">Security Guides</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-lg p-8 border border-gray-200 slide-up">
              ...
              <h3 className="text-xl font-bold text-black mb-4">Webinars</h3>
              <p className="text-gray-600 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden slide-up">
              ...
              <div className="p-6">
                <div className="flex items-center mb-2">
                  <span className="bg-black text-white text-xs font-semibold px-2 py-1 rounded">Webinar</span>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="max-w-md mx-auto flex gap-4 slide-up">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 rounded-lg text-gray-900 placeholder-gray-500 bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-white focus:border-white"
              />
